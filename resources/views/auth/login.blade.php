...
<html lang="en">
    ...
    <head>
        <title>Login | Ekstrakulikuler</title>
        <!--[if lt IE 9]>
                            ...
                            <form class="md-float-material" action="{{ route('login') }}" method="POST">
                                ...
                                <div class="auth-box">
                                    ...
                                    <div class="input-group">
                                        <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Your Email Address" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                        @error('email')
                                    ...
                                    <div class="row m-t-25 text-left">
                                        ...
                                        <div class="col-sm-5 col-xs-12 forgot-phone text-right">
                                            <a href="{{ route('register') }}" class="text-right f-w-600 text-inverse"> {{ __('Register?') }}</a>
                                            @endif
                                        </div>
                                    </div>
