<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('frontend') }}/assets/pages/flag-icon/flag-icon.min.css">
	<link rel="stylesheet" type="text/css" href="{{ asset('frontend') }}/assets/pages/menu-search/css/component.css">
	<link rel="stylesheet" type="text/css" href="{{ asset('frontend') }}/assets/pages/dashboard/horizontal-timeline/css/style.css">
	<link rel="stylesheet" type="text/css" href="{{ asset('frontend') }}/assets/pages/dashboard/amchart/css/amchart.css">
	<link rel="stylesheet" type="text/css" href="{{ asset('frontend') }}/assets/pages/flag-icon/flag-icon.min.css">
	<link rel="stylesheet" type="text/css" href="{{ asset('frontend') }}/assets/css/style.css">
	<link rel="stylesheet" type="text/css" href="{{ asset('frontend') }}/assets/css/color/color-1.css" id="color" />
	<link rel="stylesheet" type="text/css" href="{{ asset('frontend') }}/assets/css/linearicons.css">
	<link rel="stylesheet" type="text/css" href="{{ asset('frontend') }}/assets/css/simple-line-icons.css">
	<link rel="stylesheet" type="text/css" href="{{ asset('frontend') }}/assets/css/ionicons.css">
