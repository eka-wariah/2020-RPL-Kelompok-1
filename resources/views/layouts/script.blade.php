...
<script type="text/javascript" src="{{ asset('frontend') }}/bower_components/classie/classie.js"></script>
<script src="{{ asset('frontend') }}/bower_components/d3/d3.js"></script>
<script src="{{ asset('frontend') }}/bower_components/rickshaw/rickshaw.js"></script>
<script src="{{ asset('frontend') }}/bower_components/raphael/raphael.min.js"></script>
<script src="{{ asset('frontend') }}/bower_components/morris.js/morris.js"></script>
<script type="text/javascript" src="{{ asset('frontend') }}/assets/pages/dashboard/horizontal-timeline/js/main.js"></script>
<script type="text/javascript" src="{{ asset('frontend') }}/assets/pages/dashboard/amchart/js/amcharts.js"></script>
<script type="text/javascript" src="{{ asset('frontend') }}/assets/pages/dashboard/amchart/js/serial.js"></script>
<script type="text/javascript" src="{{ asset('frontend') }}/assets/pages/dashboard/amchart/js/light.js"></script>
<script type="text/javascript" src="{{ asset('frontend') }}/assets/pages/dashboard/amchart/js/custom-amchart.js"></script>
...
<script src="{{ asset('frontend') }}/assets/js/demo-12.js"></script>
